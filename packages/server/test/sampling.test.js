...
describe('createAsk()', () => {
  it('throws if sendRequest is not a function', () => {
    ...
    expect(() => createAsk('not a function', { sampling: true })).toThrow(/sendRequest to be a function/);
  });
...
describe('ask() - edge cases', () => {
  ...
  it('handles special characters in prompt', async () => {
    ...
    expect(sendRequest).toHaveBeenCalledWith('sampling/createMessage', expect.objectContaining({
